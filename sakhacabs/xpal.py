...
def new_locationupdate(driver,timestamp,checkin=True,location=None,vehicle=None,handoff=None,logger=xetrapal.astra.baselogger,**kwargs): 
    ...
    locationupdate=documents.LocationUpdate(driver=driver,timestamp=adjtimestamp,location=location,checkin=checkin,handoff=handoff,vehicle=vehicle)
    locationupdate.save()
...
def get_vehicle_by_vnum(vnum):
    ...
    t=documents.Vehicle.objects(vehicle_num=vnum)
